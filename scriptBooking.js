...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Current date and time (02:16 PM SAST, May 15, 2025)
    const currentDate = new Date('2025-05-15T14:16:00+02:00');
    const fullyBookedDates = ['2025-05-16', '2025-05-20', '2025-05-21', '2025-05-22', '2025-05-23', '2025-05-30', '2025-05-31'];
    ...
    function initializeBookingForm() {
        ...
        if (!checkInInput || !checkOutInput || !nightsInput || !halfDayToggle) {
            console.error('One or more booking form elements not found');
            return;
        }
        ...
        document.getElementById('confirm-booking-btn').addEventListener('click', () => {
            ...
            const bookingDetails = {
                ...
                rooms: JSON.stringify(selectedRooms) // Stringify to match URL handling
            };
